...
namespace Web_Ban_Giay_2.Controllers
{
    public class DonHangController : Controller
    {
        ...
        public ActionResult Index(int? page)
        {
            ...
            var links = (from l in db.DonHangs
                         select l).OrderBy(x => x.Madh);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Madh,Makh,Tendh,Ngaydat,Ngaygiao,Tinhtranggh,Dathanhtoan")] DonHang donHang)
        {
            if (ModelState.IsValid)
            {
